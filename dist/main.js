...
var map = {
	"./admin/admin.module": [
		...
		"default~admin-admin-module~login-login-module~motorizado-motorizado-module~register-register-module",
		"default~admin-admin-module~motorizado-motorizado-module~register-register-module",
		"default~admin-admin-module~motorizado-motorizado-module",
		"common",
		"admin-admin-module"
	],
	"./login/login.module": [
	...
	"./validate-registro/validate-registro.module": [
...
var routes = [
    {
        ...
        children: [
            ...
            {
                path: "validar",
                loadChildren: "./validate-registro/validate-registro.module#ValidateRegistroModule",
            },
            {
                path: "",
...
module.exports = __webpack_require__(/*! C:\Users\LUIS\Escritorio\JapiExpress\src\main.ts */"./src/main.ts");
