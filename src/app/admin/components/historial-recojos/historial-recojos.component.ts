...
@Component({
  selector: 'app-historial-recojos',
  templateUrl: './historial-recojos.component.html',
  styleUrls: ['./historial-recojos.component.css']
})
export class HistorialRecojosComponent implements OnInit {
  token: string;
  data: [];
  datos: [];
  id: any;
  ...
  @Input() spinner = [
    ...
    { descripcion: "Distrito", id: "distrito" },
    { descripcion: "Descripcion del producto", id: "descripcion" },
    { descripcion: "Nombre Motorizado", id: "moto" },
  ];
  ...
  getDataByDate(token: string, date1: string, date2: string) {
    ...
    this.http
      .post(
        `${environment.url_api}/empresa/HistorialRecojos`,
        // "https://backend-japi.herokuapp.com/empresa/HistorialRecojos",
